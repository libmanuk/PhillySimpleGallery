...
$items = get_records('Item', array(), $totalrecs);
set_loop_records('items', $items)
?>
<button id="splashsort" style="display:none;">Sort</button>
<div id="primary">
    <h1><?php echo html_escape(get_option('philly_simple_gallery_page_title')); ?></h1>
<div id="simple-splash">
    <div id="form-instructions">
        <?php echo get_option('philly_simple_gallery_page_instructions'); // HTML ?>
    </div>
